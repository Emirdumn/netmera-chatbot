...
def is_netmera_related(question: str, history: str = "") -> bool:
    ...
    Sonuc proses-ici + Redis cache'lenir; ayni soru icin ikinci LLM cagrisi olmaz.
    """
    ...
    # source/search_query istemeden sadece alakalilik — ayni prompt kurallari.
    decision = llm.invoke(
...
def _decide_domain(state, question: str) -> DomainDecision:
    ...
    # general_agent ayni turda tekrar sormasin diye bool'u cache'le.
